...
ptm <- proc.time()
#Model w/ searchterm and pol.bias without year
m10<-brms::brm(bf(sentiment ~ 1 + searchTerm * politicalBias + (1|aInd),sigma~politicalBias), data = df,family=gaussian, chains=2,cores=2)
proc.time() - ptm
summary(m10)
#Shows the interactions and effects
...
memory.limit(12210) #12210
## To increase the storage capacity
memory.limit(size=12210)
