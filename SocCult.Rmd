...
m2<-brms::brm(bf(sentiment ~ 1 + year * searchTerm * politicalBias+ (1|article),sigma~politicalBias), dfSub, family=gaussian, chains=2,cores=2)
...
compare_ic(m1.a,m2.a,ic="waic")
model_weights(m1.a,m2.a,ic="waic")
```
